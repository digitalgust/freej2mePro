 ...
 *
 * Ported from KEmulator micro3d_gl into freej2me. Standard API shell holding
 * the per-draw shading/toon/sphere/transparency effect. Package-private fields
 * are read by Graphics3D/RenderProxy when translating to engine state.
 */
